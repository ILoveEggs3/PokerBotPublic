...
namespace Resources.TwoMax.EspaceJeux
{
	 public sealed class Constantes : CConstantsTable
	 {
		...
		private static readonly Rectangle FFACTION_BUTTON_BET = new Rectangle(532, 442, 45, 15);
		public override Rectangle ACTION_BUTTON_BET { get { return FFACTION_BUTTON_BET; } }
		
		#endregion
		
		#region ACTION_BUTTON_CALL
		
		private static readonly Rectangle FFACTION_BUTTON_CALL = new Rectangle(435, 442, 85, 15);
		public override Rectangle ACTION_BUTTON_CALL { get { return FFACTION_BUTTON_CALL; } }
		...
		private static readonly Rectangle FFACTION_TXT_BET = new Rectangle(581, 444, 30, 11);
		public override Rectangle ACTION_TXT_BET { get { return FFACTION_TXT_BET; } }
		...
		private static readonly Rectangle FFPLAYER_0_EMPTY = new Rectangle(86, 316, 6, 6);
		...
		private static readonly Rectangle FFPLAYER_1_BET = new Rectangle(445, 261, 50, 6);
		...
		private static readonly Rectangle FFPLAYER_1_EMPTY = new Rectangle(544, 316, 6, 6);
		...
		private static readonly Rectangle FFPOT = new Rectangle(312, 254, 50, 6);
