...
namespace TestApp
{
    class Program
    {
        ...
        {
            [DllImport(@"C:\Users\beao3002\Desktop\DLLOpenCLTestProject\DLLProject\Debug\DLLProject.dll", EntryPoint = "OCL")]
            public static extern void OCL();

            [DllImport("../../../../Debug/DLLProject.dll", EntryPoint = "MatMulV1Call", CallingConvention = CallingConvention.Cdecl)]
            public static extern void MatMulV1Call();

            [DllImport("../../../../Debug/DLLProject.dll", EntryPoint = "MatMulV2Call", CallingConvention = CallingConvention.Cdecl)]
            public static extern void MatMulV2Call();

            [DllImport("../../../../Debug/DLLProject.dll", EntryPoint = "MatMulV3Call", CallingConvention = CallingConvention.Cdecl)]
            public static extern void MatMulV3Call();

            [DllImport("../../../../Debug/DLLProject.dll", EntryPoint = "BitmapAnalyse", CallingConvention = CallingConvention.Cdecl)]
            public unsafe static extern UInt32 BitmapAnalyse(byte* ptr0, int width, int heigth,
                void* refPtrAr, int arraySize, int* retValues);

            [DllImport("../../../../Debug/DLLProject.dll", EntryPoint = "BitmapAnalyseV2", CallingConvention = CallingConvention.Cdecl)]
        ...
        public unsafe void testBitmapDistancesV1()
        {
            ...
            int lol = (int)MyClass.BitmapAnalyse((byte*)bmp.Scan0, bmp.Width, bmp.Height, qwe.ToPointer(), refBmpPtrs.Length, (int*)retValues.ToPointer());
        ...
        public unsafe void testBitmapDistancesV2()
        {
            var watch = System.Diagnostics.Stopwatch.StartNew();
            List<Bitmap> bmpRefList = new List<Bitmap>();
            ...
            bmpSamplesList.Add(Properties.Resources.R2);
            bmpSamplesList.Add(Properties.Resources.B2);
            bmpSamplesList.Add(Properties.Resources.B4);
            bmpSamplesList.Add(Properties.Resources.B9);
            bmpSamplesList.Add(Properties.Resources.RA);
            bmpSamplesList.Add(Properties.Resources.R5);
            ...
            int ret = (int)MyClass.BitmapAnalyseV2(
