...
namespace HandHistories.Objects.GameDescription
{
    ...
    public class Buyin
    {
        ...
        private Buyin(double prizePool, double rake, Currency currency, bool isKnockout, double knockoutValue)
        {
            Currency = currency;
        ...
        public static Buyin FromBuyinRake(double prizePoolValue,
                                          double rake,
                                          Currency currency,
                                          bool isKnockout = false,
                                          double knockoutValue = 0)
        {
        ...
        [DataMember]
        public double PrizePoolValue { get; private set; }
        ...
        public LimitGrouping GetLimitGrouping()
        {
            ...
            if (combinedValue < 20.0)
            {
                return LimitGrouping.Small;
            }
            if (combinedValue < 100.0)
            {
        ...
        public static Buyin ParseDbSafeString(string buyinString)
        {
            ...
            double prizePoolValue = Int32.Parse(split[0]) / 100.0;
            double rake = 0.0;
            ...
            if(split.Length == 4)
            {
                knockoutValue = Int32.Parse(split[1]) / 100.0;
                rake = Int32.Parse(split[2]) / 100.0;
            ...
            else if(split.Length == 3)
            {
                ...
                else
                {
                    ...
                    rake = Int32.Parse(split[1]) / 100.0;
                }
            }
