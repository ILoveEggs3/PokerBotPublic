            ...
            try
            {
                ...
                else if (!string.IsNullOrWhiteSpace(gameLimitWithSlash))
                {
                    ...
                    if (gameType != GameType.FixedLimitHoldem)
                        gameLimitNoSlash = (double.Parse(gameLimitNoSlash, System.Globalization.CultureInfo.InvariantCulture) * 100).ToString();
                }
                ...
                if (gameType == GameType.FixedLimitHoldem)
                {
                    bigBlind = double.Parse(gameLimitNoSlash, System.Globalization.CultureInfo.InvariantCulture);
                ...
                double buyIn = double.Parse(gameLimitNoSlash, System.Globalization.CultureInfo.InvariantCulture);
                bigBlind = buyIn/100.0;
