...
namespace HandHistories.Parser.Parsers.FastParser.PokerStars
{
    public class PokerStarsFastParserImpl : HandHistoryParserFastImpl, IThreeStateParser
    {
        ...
        protected override void ParseExtraHandInformation(string[] handLines, HandHistorySummary handHistorySummary)
        {
            ...
            for (int i = handLines.Length - 1; i >= 0; i--)
            {
                ...
                if (line[0] == '*' && line[4] == 'S')
                {
                    ...
                    // Gérer le cas où quelqu'un a parlé
                    int index = i + 1;
                    while (handLines[index].Contains(':'))
                        ++index;

                    string totalLine = handLines[index];
                    ...
                    handHistorySummary.Rake = double.Parse(rake, NumberStyles.AllowCurrencySymbol | NumberStyles.Number, _numberFormatInfo);

                    string totalPot = totalLine.Substring(10, spaceAfterFirstNumber - 10);

                    handHistorySummary.TotalPot = double.Parse(totalPot, NumberStyles.AllowCurrencySymbol | NumberStyles.Number, _numberFormatInfo);
        ...
        protected override Limit ParseLimit(string[] handLines)
        {
            ...
            double small = double.Parse(smallBlind, NumberStyles.AllowCurrencySymbol | NumberStyles.Number, _numberFormatInfo);
            double big = double.Parse(bigBlind, NumberStyles.AllowCurrencySymbol | NumberStyles.Number, _numberFormatInfo);
        ...
        protected override Buyin ParseBuyin(string[] handLines)
        {
            ...
            double prizePoolValue;
            double rake;
            double knockoutValue = 0.0;

            var buyinSplit = buyinSubstring.Split('+');
            if (buyinSplit.Length == 3)
            {
                prizePoolValue = double.Parse(buyinSplit[0], NumberStyles.AllowCurrencySymbol | NumberStyles.Number, _numberFormatInfo);
                knockoutValue = double.Parse(buyinSplit[1], NumberStyles.AllowCurrencySymbol | NumberStyles.Number, _numberFormatInfo);
                rake = double.Parse(buyinSplit[2], NumberStyles.AllowCurrencySymbol | NumberStyles.Number, _numberFormatInfo);
            }
            else if (buyinSplit.Length == 2)
            {
                prizePoolValue = double.Parse(buyinSplit[0], NumberStyles.Currency, _numberFormatInfo);
                rake = double.Parse(buyinSplit[1], NumberStyles.AllowCurrencySymbol | NumberStyles.Number, _numberFormatInfo);
            }
            else
            {
            ...
            return Buyin.FromBuyinRake(prizePoolValue, rake, currency, knockoutValue != 0, knockoutValue);
        }
        ...
        public HandAction ParsePostingActionLine(string actionLine, int colonIndex, bool smallBlindPosted, bool bigBlindPosted)
        {
            ...
            double amount = double.Parse(actionLine.Substring(firstDigitIndex, actionLine.Length - firstDigitIndex), NumberStyles.AllowCurrencySymbol | NumberStyles.Number, _numberFormatInfo);
        ...
        public HandAction ParseRegularActionLine(string actionLine, int colonIndex, Street currentStreet)
        {
            ...
            switch (actionIdentifier)
            {
                ...
                case 'c':
                    ...
                    amount = double.Parse(actionLine.Substring(firstDigitIndex, actionLine.Length - firstDigitIndex), NumberStyles.AllowCurrencySymbol | NumberStyles.Number, _numberFormatInfo);
        ...
        public HandAction ParseCollectedLine(string actionLine, Street currentStreet)
        {
            ...
            double amount = double.Parse(actionLine.Substring(firstAmountDigit, actionLine.Length - firstAmountDigit), NumberStyles.AllowCurrencySymbol | NumberStyles.Number, _numberFormatInfo);
        ...
        public HandAction ParseUncalledBetLine(string actionLine, Street currentStreet)
        {
            ...
            double amount = double.Parse(actionLine.Substring(14, closeParenIndex - 14), NumberStyles.AllowCurrencySymbol | NumberStyles.Number, _numberFormatInfo);
        ...
        protected override PlayerList ParsePlayers(string[] handLines)
        {
            ...
            for (int lineNumber = 2; lineNumber < handLines.Length - 1; lineNumber++)
            {
                ...
                double stack = double.Parse(stackString, NumberStyles.AllowCurrencySymbol | NumberStyles.Number, _numberFormatInfo);
