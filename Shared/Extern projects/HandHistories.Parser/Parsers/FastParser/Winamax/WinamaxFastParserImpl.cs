...
namespace HandHistories.Parser.Parsers.FastParser.Winamax
{
    public sealed class WinamaxFastParserImpl : HandHistoryParserFastImpl
    {
        ...
        protected override Limit ParseLimit(string[] handLines)
        {
            ...
            double smallBlind = double.Parse(lineSplit[5].Substring(parenIndex + 1, slashIndex - parenIndex - 1), NumberStyles.AllowCurrencySymbol | NumberStyles.Number, _numberFormatInfo);
            double bigBlind = double.Parse(lineSplit[5].Substring(slashIndex + 1, lineSplit[5].Length - slashIndex - 3), NumberStyles.AllowCurrencySymbol | NumberStyles.Number, _numberFormatInfo);
        ...
        protected override List<HandAction> ParseHandActions(string[] handLines, GameType gameType = GameType.Unknown)
        {
            ...
            for (int i = startOfActionsIndex; i < handLines.Length; i++)
            {
                ...
                if (currentStreet == Street.Showdown)
                {
                    ...
                    if(handLine.StartsWith("Seat "))
                    {
                        ...
                        if (wonIndex != -1)
                        {
                            ...
                            double amount = double.Parse(handLine.Substring(wonIndex + 5, currencyIndex - wonIndex - 4), NumberStyles.AllowCurrencySymbol | NumberStyles.Number, _numberFormatInfo);
                ...
                if(currentStreet.Equals(Street.Null))
                {
                    ...
                    var amount = double.Parse(handLine.Substring(amountStartIndex + 1, handLine.Length - amountStartIndex - 1), NumberStyles.AllowCurrencySymbol | NumberStyles.Number, _numberFormatInfo);
                ...
                else
                {
                    ...
                    if(currencyIndex != lastCurrencyIndex)
                    {
                        ...
                        amount = double.Parse(handLine.Substring(lastAmountIndex, lastCurrencyIndex - lastAmountIndex), NumberStyles.AllowCurrencySymbol | NumberStyles.Number, _numberFormatInfo);
                    }
                    else
                    {
                        amount = double.Parse(handLine.Substring(amountIndex, currencyIndex - amountIndex), NumberStyles.AllowCurrencySymbol | NumberStyles.Number, _numberFormatInfo);
                    }
        ...
        protected override PlayerList ParsePlayers(string[] handLines)
        {
            ...
            for (int i = 2; i < handLines.Length; i++)
            {
                ...
                playerList.Add(new Player(name, double.Parse(amount, NumberStyles.AllowCurrencySymbol | NumberStyles.Number, _numberFormatInfo), seatNumber));
            }
