...
namespace HandHistories.Parser.Parsers.FastParser.Merge
{
    public sealed class MergeFastParserImpl : HandHistoryParserFastImpl
    {
        ...
        protected override Limit ParseLimit(string[] handLines)
        {
            ...
            return Limit.FromSmallBlindBigBlind(double.Parse(smallBlindString, System.Globalization.CultureInfo.InvariantCulture),
                                                double.Parse(bigBlindString, System.Globalization.CultureInfo.InvariantCulture),
                                                Currency.USD);
        }
        ...
        private WinningsAction GetWinningsActionFromWinnerElement(XElement winnerElement, PlayerList playerList)
        {
            ...
            double amount = double.Parse(winnerElement.Attribute("amount").Value, System.Globalization.CultureInfo.InvariantCulture);
        ...
        private HandAction GetHandActionFromEventElement(XElement eventElement, Street currentStreet, PlayerList playerList)
        {
            ...
            {
                value = double.Parse(eventElement.Attribute("amount").Value, System.Globalization.CultureInfo.InvariantCulture);
            }
        ...
        protected override PlayerList ParsePlayers(string[] handLines)
        {
            ...
            foreach (XElement playerElement in players.Elements())
            {
                ...
                double stack = double.Parse(playerElement.Attribute("balance").Value.Substring(1), System.Globalization.CultureInfo.InvariantCulture);
