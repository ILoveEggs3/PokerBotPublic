...
namespace HandHistories.Parser.Parsers.FastParser.MicroGaming
{
    internal sealed class MicroGamingFastParserImpl : HandHistoryParserFastImpl
    {
        ...
        protected override Limit ParseLimit(string[] handLines)
        {
            ...
            double small = double.Parse(smallString, System.Globalization.CultureInfo.InvariantCulture);


            string bigString = limitString.Substring(slashIndex + 1, limitString.Length - (slashIndex + 1));
            double big = double.Parse(bigString, System.Globalization.CultureInfo.InvariantCulture);
        ...
        static double GetAmountFromActionLine(string line)
        {
            return double.Parse(GetAttribute(line, " amount=\""), provider);
        }
        ...
        static double GetValueFromActionLine(string actionLine)
        {
        ...
        protected override PlayerList ParsePlayers(string[] handLines)
        {
            ...
            for (int i = 0; i < playerLines.Length; i++)
            {
                ...
                double stack = double.Parse(GetAttribute(line, " balance=\""), provider);
        ...
        protected override void ParseExtraHandInformation(string[] handLines, HandHistorySummary handHistory)
        {
            ...
            handHistory.Rake = double.Parse(rakeString)/100.0;
            ...
            for (int k = winningsLine; k < handLines.Length - 1; k++)
            {
                ...
                handHistory.TotalPot += double.Parse(amountString, provider);
            }
        }
    }
}
