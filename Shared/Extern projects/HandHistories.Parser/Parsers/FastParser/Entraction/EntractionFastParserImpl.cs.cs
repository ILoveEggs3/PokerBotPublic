...
namespace HandHistories.Parser.Parsers.FastParser.Entraction
{
    sealed class EntractionFastParserImpl : HandHistoryParserFastImpl
    {
        ...
        protected override Limit ParseLimit(string[] handLines)
        {
            ...
            double lowLimit = double.Parse(limitString.Split('/')[0], System.Globalization.CultureInfo.InvariantCulture);
            double highLimit = double.Parse(limitString.Split('/')[1], System.Globalization.CultureInfo.InvariantCulture);
        ...
        protected override List<HandAction> ParseHandActions(string[] handLines, GameType gameType = GameType.Unknown)
        {
            ...
            for (int i = 3; i < handLines.Length - 1; i++)
            {
                ...
                if (handLine.Contains(" wins: "))
                {
                    ...
                    name = handLine.Substring(0, firstSpaceIndexOf);
                    amount = double.Parse(handLine.Substring(lastSpaceIndex + 1, handLine.Length - lastSpaceIndex - 1), System.Globalization.CultureInfo.InvariantCulture);
                ...
                if (openParenIndex != -1)
                {
                    amount = double.Parse(handLine.Substring(openParenIndex + 1, handLine.Length - openParenIndex - 2), System.Globalization.CultureInfo.InvariantCulture);
                }
        ...
        protected override PlayerList ParsePlayers(string[] handLines)
        {
            ...
            for (int i = 2; i <= handLines.Length - 1; i++)
            {
                ...
                double amount = double.Parse(seatData[1], System.Globalization.CultureInfo.InvariantCulture);
