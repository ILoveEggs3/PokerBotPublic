...
namespace HandHistories.Parser.Utils.AllInAction
{
    public static class AllInActionHelper
    {
        ...
        /// <returns></returns>
        public static HandActionType GetAllInActionType(string playerName, double amount, Street street, List<HandAction> actions)
        {
        ...
        public static double GetAdjustedCallAllInAmount(double amount, IEnumerable<HandAction> playerActions)
        {
